...
AND SGBSTDN_TERM_CODE_EFF = (SELECT MAX(A.SGBSTDN_TERM_CODE_EFF)
  ...
  and sfrstcr_term_code IN ('201610') --change TERM codes here for the 150% condition
...
-- don't use ORDER BY because T1 needs to show at the bottom row